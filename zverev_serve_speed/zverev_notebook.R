...
source("~/Documents/tennis/serve_speeds/src/collect_speed_data_functions.R")
...
source("~/Documents/tennis/serve_speeds/src/summary_stats.R")
...
source("~/Documents/tennis/serve_speeds/src/grouped_score.R")
...
source("~/Documents/tennis/serve_speeds/src/serve_rates.R")
...
plot_df_rates(zverev_double_faults_data)
#dev.off()
